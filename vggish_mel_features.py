...
def stft_magnitude(signal, fft_length,
    ...
    frames = np.vstack((frames, np.zeros((1, 256))))
...
def audio_to_magnitude_db_and_phase(audio, fft_length, hop_length):

    stftaudio = librosa.stft(
        audio, n_fft=fft_length, hop_length=hop_length, window=scipy.signal.hamming)
